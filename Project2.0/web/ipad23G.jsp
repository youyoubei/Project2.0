...
<html>
  <head>
    ...
    <title>My JSP 'ipad23G.jsp' starting page</title>
...
<table  align="center" width="950"  height="300" border="1" cellspacing="0" cellpadding="0" style="font-size: 12px">
  <tr>
    <td width="323" rowspan="6" align="center" bgcolor="#FFFFFF"><h3><img src="imagesipad/ipad2 16Gwifi3G.jpg" width="300" height="300" /></h3></td>
    <td width="310" height="50" bgcolor="#737373"><h3>价格：￥3988</h3></td>
    <td width="311" height="50" align="center" valign="middle" bgcolor="#737373">
    <a href="servlet/CartServlet?method=addCart&pid=${pid }"><img src="images/btn_addcart.gif" width="122" height="35" border="0"/></a></td>
  </tr>
  <tr>
    <td height="50" bgcolor="#737373">外观设计：平板</td>
    <td height="50" bgcolor="#737373">网络模式：wifi,3G</td>
  </tr>
  <tr>
    <td height="50" bgcolor="#737373">触摸屏：电容屏，多点触控</td>
    <td height="50" bgcolor="#737373">摄像头：前30万像素，后70万像素</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">主屏尺寸：9.7英寸</td>
    <td height="70" bgcolor="#737373">电池容量：10小时</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">机身内存：16G</td>
    <td height="70" bgcolor="#737373">操作系统：iOS 4.3</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">蓝牙传输：支持蓝牙2.1</td>
    <td height="70" bgcolor="#737373">CPU频率：1GHz</td>
  </tr>
  <tr>
    <td width="323" align="center" bgcolor="#737373">ipad2 16G 3G版</td>
    <td height="70" bgcolor="#737373">产品系列：苹果ipad2系列</td>
