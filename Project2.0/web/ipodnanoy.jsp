...
<html>
  <head>
    ...
    <title>My JSP 'ipodnanoy.jsp' starting page</title>
...
<table  align="center" width="950"  height="580"border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td width="323" rowspan="6" align="center" bgcolor="#FFFFFF"><h3><img src="imagesipod/nanoy.jpg" width="300" height="300" /></h3></td>
    <td width="310" height="70" bgcolor="#737373"><h3>价格：￥1148</h3></td>
  ...
  <tr>
    <td height="70" bgcolor="#737373">外观设计：直桶</td>
    <td height="70" bgcolor="#737373">网络模式：无</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">触摸屏：无</td>
    <td height="70" bgcolor="#737373">摄像头：无</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">主屏尺寸：无</td>
    <td height="70" bgcolor="#737373">电池容量：1200mAh</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">机身内存：1G</td>
    <td height="70" bgcolor="#737373">操作系统：Nano</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">蓝牙传输：不支持</td>
    <td height="70" bgcolor="#737373">CPU频率：512MHZ</td>
  </tr>
  <tr>
    <td width="323" align="center" bgcolor="#737373">Nano 黄色版</td>
