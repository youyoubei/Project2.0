...
<html>
  <head>
    ...
    <title>My JSP 'macAir969.jsp' starting page</title>
...
<table  align="center" width="950"  height="580"border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td width="323" rowspan="6" align="center" bgcolor="#FFFFFF"><h3><img src="imagesmac/macAir969.jpg" width="300" height="300" /></h3></td>
    <td width="310" height="70" bgcolor="#737373"><h3>价格：￥6898</h3></td>
  ...
  <tr>
    <td height="70" bgcolor="#737373">主屏尺寸：13.5英寸</td>
  ...
  <tr>
    ...
    <td height="70" bgcolor="#737373">CPU频率：2.4GHz</td>
  </tr>
  <tr>
    <td width="323" align="center" bgcolor="#737373">macAirbook 969版</td>
...
<div style="float:left">
        <ul style="list-style:none">
          <li class="li">访问&nbsp;</li>
          <li class="li"> <a href="#">Apple Store 在线商店</a>&nbsp;</li>
          <li class="li">(400-666-8800)，</li>
          <li class="li"> <a href="#">Apple Store 零售</a>&nbsp;</li>
          <li class="li">，或查找在你附近的&nbsp; </li>
          <li class="li"><a href="#">Apple 经销商</a>。&nbsp;</li>
    </ul>
  </div>
         <!--------------------- right -------------------------->
        <div style="float:right">
        <ul style="list-style:none">
           <li class="li2"><a href="#">网站地图</a>&nbsp;</li>
           <li class="li2"><img src="images/hr2.png" />&nbsp;</li>
           <li class="li2"><a href="#">热点新闻</a>&nbsp;</li>
           <li class="li2"><img src="images/hr2.png" />&nbsp;</li>
           <li class="li2"><a href="#">媒体中心</a>&nbsp;</li>
           <li class="li2"><img src="images/hr2.png" />&nbsp;</li>
           <li class="li2"><a href="#">环境</a>&nbsp;</li>
           <li class="li2"><img src="images/hr2.png" />&nbsp;</li>
           <li class="li2"><a href="#">工作机会</a>&nbsp;</li>
           <li class="li2"><img src="images/hr2.png" />&nbsp;</li>
           <li class="li2"><a href="#">联系我们</a>&nbsp;</li>        
        </ul>
     </div>     
  </div>
<div style="float:float; margin-top:60px;">
   <hr   style="margin-left:40px; margin-top:auto"/>
        <ul style="list-style:none">
           <li class="li2">Copyright © 2012 Apple Inc. 保留所有权利。</li>
            <li class="li2"><a href="#">使用条款</a>&nbsp;</li>        
            <li class="li2"><img src="images/hr2.png" />&nbsp;</li>
            <li class="li2"><a href="#">客户私隐政策</a>&nbsp;</li>        
        </ul>
  </div>   
