...
<html>
  <head>
    ...
    <title>My JSP 'iphone4Sb.jsp' starting page</title>
...
<table  align="center" width="950"  height="580"border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td width="323" rowspan="6" align="center" bgcolor="#FFFFFF"><h3><img src="imagesiphone/ipnone4S 16GH.jpg" width="300" height="300" /></h3></td>
    <td width="310" height="70" bgcolor="#737373"><h3>价格：￥4738</h3></td>
  ...
  <tr>
    <td height="70" bgcolor="#737373">外观设计：直板</td>
    <td height="70" bgcolor="#737373">网络模式：wifi,3G</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">触摸屏：电容屏，多点触控</td>
    <td height="70" bgcolor="#737373">摄像头：前30万像素，后800万像素</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">主屏尺寸：3.5英寸</td>
    <td height="70" bgcolor="#737373">电池容量：1420mAh</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">机身内存：512MB RAM</td>
    <td height="70" bgcolor="#737373">操作系统：iOS 5.0</td>
  </tr>
  <tr>
    <td height="70" bgcolor="#737373">蓝牙传输：支持蓝牙2.0</td>
    <td height="70" bgcolor="#737373">CPU频率：800MHZ</td>
  </tr>
  <tr>
    <td width="323" align="center" bgcolor="#737373">iphone4S 16G 黑版</td>
    <td height="70" bgcolor="#737373">产品系列：苹果iphone4S系列</td>
